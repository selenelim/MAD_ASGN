        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 6),
              Text('1–3 hours', style: TextStyle(color:Theme.of(context).scaffoldBackgroundColor)),
              SizedBox(width: 16),
              Icon(Icons.attach_money, color:Theme.of(context).scaffoldBackgroundColor, size: 18),
              SizedBox(width: 6),
              Text('30 – 150', style: TextStyle(color:Theme.of(context).scaffoldBackgroundColor)),
            ],
          ),
        ],
      ),
